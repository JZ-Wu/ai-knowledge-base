...
### 7. 前向过程详解：点云如何被 Encoder 压缩、被 Decoder 还原
...
- 窗口内做**标准 Multi-Head Self-Attention**（不再是 V1/V2 的 Vector Attention）
...
| 版本 | 年份 | 注意力类型 | 邻域定义 | 下采样 | 核心亮点 |
|:-----|:-----|:----------|:--------|:-------|:---------|
| **V1** | 2021 | Vector Attention | KNN ($K=16$) | FPS | 首次将 Transformer 成功应用于点云，向量注意力 |
| **V2** | 2022 | Grouped Vector Attention | KNN | Grid Pooling | 分组降低计算量，Grid Pooling 替代 FPS |
| **V3** | 2024 | Serialized Window Attention | 序列化窗口 | Grid Pooling | 放弃 KNN，空间填充曲线 + FlashAttention，3x 提速 |
...
### Q4: Point Transformer vs 3D 稀疏卷积各自优势？
